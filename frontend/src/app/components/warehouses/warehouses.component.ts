...
export class WarehousesComponent implements OnInit {
  ...
  addHardcodedWarehouses() {
    this.warehouses = [
      { id: 1, code: 'WH01', name: 'Central Warehouse', location: '123 Industrial Ave', capacity: 10000, currentStock: 7500, contactPhone: '555-0101', contactEmail: 'wh01@wsscms.com', isActive: true, managerId: 1, createdAt: new Date(), updatedAt: new Date() } as any,
